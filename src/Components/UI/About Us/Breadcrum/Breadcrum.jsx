...
import bg_image from "../../../../images_new/background_2.png"
...
const Breadcrumb = () => {
          ...
          <div className="col-lg-6">
            <div className="banner-img">
              <div className="banner-img-1">
                ...
                <img src={banner_img_1} alt="banner" />
              </div>
              <div className="banner-img-2">
                ...
                <img src={banner_img_2} alt="banner" />
              </div>
            </div>
          </div>
        </div>
  ...
  style={{
    ...
    backgroundImage: `url(${bg_image})`,
    backgroundPosition: "center",
    backgroundSize: "cover", // To ensure the background image covers the screen on smaller devices
  }}
>
  <div className="container">
    <div className="row align-items-center">
      ...
      <div className="col-lg-6 col-8">
        <div className="banner-img">
          <div className="banner-img-1">
            ...
            <img src={banner_img_1} alt="banner" className="w-full h-auto" />
          </div>
          <div className="banner-img-2">
            <svg width="100%" height="100%" viewBox="0 0 673 673" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <img src={banner_img_2} alt="banner" className="w-full h-auto" />
          </div>
        </div>
      </div>
    </div>
