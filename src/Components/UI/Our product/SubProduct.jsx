...
const SubProduct = () => {
  ...
  return (
    ...
    <div className="flex justify-start mt-6 space-x-2">
        ...
        <button className="bg-gray-300 rounded-full px-4 py-2 text-white">S</button>
        <button className="bg-gray-300 rounded-full px-4 py-2 text-white">M</button>
        <button className="bg-gray-300 rounded-full px-4 py-2 text-white">L</button>
        <button className="bg-gray-300 rounded-full px-4 py-2 text-white">XL</button>
        <button className="bg-gray-300 rounded-full px-4 py-2 text-white">XXL</button>
    </div>
    ...
    <div className="flex items-center mt-6 space-x-4">
      ...
      <span className='mx-2 px-3 text-2xl'><b>${price}</b></span>
    </div>

    <div className="flex mt-6 space-x-4">
        <button onClick={()=>handlecart(proddata)} className="bg-orange-600 rounded-full px-8 py-3 text-white font-semibold  transition duration-200">Add to Cart</button>
        <button className="bg-orange-600 rounded-full px-8 py-3 text-white font-semibold  transition duration-200">Buy Now</button>
    </div>
</div>
