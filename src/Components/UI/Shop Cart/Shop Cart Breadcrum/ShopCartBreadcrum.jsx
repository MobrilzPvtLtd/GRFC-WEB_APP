...
const ShopCartBreadcrum = () => {
  return (
    ...
    >
        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="banner-text">
              <h2 className='text-7xl font-bold'>Shop Cart</h2>
      ...
      <img src={heroShape1} alt="hero-shaps" className="img-2" />
      <img src={heroShape1} alt="hero-shaps" className="img-4" />
    </section>
...
export default ShopCartBreadcrum
